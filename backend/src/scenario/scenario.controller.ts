import { Controller, Post, Logger, HttpException, HttpStatus, UseInterceptors, UploadedFile } from '@nestjs/common';
...
export class ScenarioController {
  ...
  async triggerScenario(@UploadedFile() file: Express.Multer.File) {
    ...
    try {
      ...
      throw new HttpException({ success: false, error: 'Scenario failed to execute: ' + error.message }, HttpStatus.BAD_REQUEST);
    }
  }
}
